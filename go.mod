...
replace charm.land/bubbletea/v2 => ./charm_libraries/bubbletea

replace charm.land/fantasy => ./charm_libraries/fantasy

replace charm.land/lipgloss/v2 => ./charm_libraries/lipgloss

replace charm.land/bubbles/v2 => ./charm_libraries/bubbles

replace charm.land/huh/v2 => ./charm_libraries/huh

replace github.com/charmbracelet/glow/v2 => ./charm_libraries/glow

replace charm.land/catwalk => ./charm_libraries/catwalk
